...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import sais_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("87580118-d570-561d-bbff-a6d0453db9f3"))
platforms = [Pkg.Artifacts.unpack_platform(e, "sais", artifacts_toml) for e in artifacts["sais"]]
...
if best_platform === nothing
    @debug("Unable to load sais; unsupported platform $(triplet(platform_key_abi()))")
else
